...
- (id)init {
	self = [super init];
	if(self != nil) {
        self.deviceToken = @"4e1e8787 4e236ea6 dedety9d 0887806b a8a8f9b6 fghc4589 b87b645c b9786b49"; // device tokek with space between two segment[8 char]
		self.payload = @"{\"aps\":{\"alert\":\"My first Notification.\",\"badge\":1}}";
		self.certificate = [[NSBundle mainBundle] pathForResource:@"Certificates_Dev_push" ofType:@"cer"];
	}
	return self;
}
